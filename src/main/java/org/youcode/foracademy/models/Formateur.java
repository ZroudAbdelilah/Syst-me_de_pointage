...
public class Formateur extends User {
    ...
    public Formateur(long id_user, String first_name, String last_name, String email, String password, long phone, String gander, boolean status_compte, Role role, Adress adress, Fabrique fabrique, Specialiter specialiter) {
